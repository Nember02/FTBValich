...
// Add ore dictionary AnyLogWood
<ore:logWood>.add(<treasure2:wither_log>);
<ore:logWood>.add(<srparasites:parasitetrunk>);
<ore:logWood>.add(<srparasites:parasitetrunk:1>);
<ore:logWood>.add(<srparasites:parasitetrunk:2>);

// Add ore dictionary Chisel
// Oak
